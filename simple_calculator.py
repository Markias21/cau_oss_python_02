...
def add_ops(num1, num2):
    sum = num1+num2
    return sum

def sub_ops(num1, num2):
    sub = num1-num2
    return sub

def other_cal(num1, num2, op):
    return op(num1, num2)
...
while True:
    ...
    if op == "end":
        ...
        num1,num2=arithmetic_ops(op)
        ret = add_ops(num1, num2)
    elif op == "-":
        num1,num2=arithmetic_ops(op)
        ret = sub_ops(num1, num2)
        
     # 정의된 함수 사용
    elif op == "*":
        num1, num2 = arithmetic_ops(op) # 익명함수(lambda) 사용
        ret = other_cal(num1, num2, lambda num1, num2:num1*num2)
